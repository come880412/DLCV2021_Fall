...
After your dataset is prepared, you should run the script as follow:
``` bash
bash download.sh # Download the pretrained models
bash inference.sh # The predicted result will save on the folder "pred"
bash train.sh
```
