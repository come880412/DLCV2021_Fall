...
def get_parameters():
    ...
    parser.add_argument('--version', type=str, default='hw2_face')
    ...
    # using pretrained
    parser.add_argument('--pretrained_model', type=int, default=516250)
    ...
    # Path
    parser.add_argument('--root_train',type=str,default='../hw2_data/face/train/')
    parser.add_argument('--log_path', type=str, default='./logs')
    parser.add_argument('--model_save_path', type=str, default='./checkpoints')
    parser.add_argument('--sample_path', type=str, default='./sample_result')
